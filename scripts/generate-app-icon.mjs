...
await sharp(iconOnlySvg).resize(1024, 1024).png().toFile(join(resourcesDir, 'icon-only.png'))
await sharp(iconSvg).resize(1024, 1024).png().toFile(join(resourcesDir, 'icon.png'))
